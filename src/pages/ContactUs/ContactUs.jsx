      ...
      <div className="bg-[#171717] overflow-hidden">
        ...
        <div className="contactus-main h-max">
          <img
            ...
            alt="contactus"
          />
          <div data-aos="flip-right" className="contactus">
            <h1>CONTACT US</h1>
        ...
        <div
          data-aos="zoom-in"
          className="flex justify-evenly items-center flex-col py-20 h-max md:flex-row md:justify-between md:px-20"
        >
          <div className="bg-[#151515] h-max md:w-1/2  px-10">
            ...
            <div className=" grid grid-cols-3 gap-2 ">
              <button
                ...
                className="text-white text-sm p-2 border-2 border-[#EF1B1C] rounded my-2"
              >
                NEW DELHI
              </button>
              <button
        ...
        <div data-aos="zoom-out" className="getintouch">
